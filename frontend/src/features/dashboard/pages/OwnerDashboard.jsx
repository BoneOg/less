  ...
  return (
    <div className="space-y-12 animate-in fade-in duration-1000 pb-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* ── MAIN CHART AREA (Real Chart with Recharts) ── */}
...
function ActivityItem({ supplier, category, time, value, alert, alertType }) {
  const alertColors = {
    danger: 'text-red-400',
...
function RecommendationRow({ item, reason, action, amount, type }) {
  const types = {
    danger: 'text-red-600',
